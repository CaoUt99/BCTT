...
class RegisterScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector( // loại bỏ bàn phím
      onTap: () => FocusScope.of(context).unfocus(),
      child: Scaffold(// chím toàn bộ màn hình
        key: _scaffoldKey,
        backgroundColor: Colors.white,
        body: Builder(
          builder: (BuildContext scaffoldContext) => Container(
            color: kBackgroundColor,// màu nền xanh
            child: Stack(
              children: <Widget>[
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,//căn chỉnh vị trí tiêu đề
                  children: <Widget>[
                    const DefaultTitle(),
                    Expanded(
                      child: Stack(
